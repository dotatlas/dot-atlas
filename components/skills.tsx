								...
								<div className="flex flex-wrap gap-2">
									{cat.skills.map((skill) => {
										...
										return (
											<span
												key={skill.name}
												className="inline-flex items-center gap-1.5 rounded-lg bg-secondary px-3 py-1.5 text-xs text-secondary-foreground transition-colors duration-300 hover:bg-primary/10 hover:text-primary"
											>
												<SkillIcon />
												{skill.name}
											</span>
