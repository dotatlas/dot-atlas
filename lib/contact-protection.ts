...
const ENCODED_RESUME_PATH = [51, 78, 115, 119, 108, 121, 101, 99, 73, 122, 105, 114, 104, 105, 114, 49, 91, 101, 112, 112, 109, 103, 111, 99, 118, 105, 119, 121, 113, 105, 50, 116, 104, 106]
...
export function getProtectedResumePath() {
  return decode(ENCODED_RESUME_PATH, RESUME_SHIFT)
}
